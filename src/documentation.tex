...
\includegraphics[width=0.5\textwidth]{img/documentation/before_theme}\\
\\ \includegraphics[width=0.5\textwidth]{img/documentation/after_theme}\\
}{
%%%% Bottom space
...
\textbf{Visit https:\slash \slash sphinxdocs.ansys.com for more information}
}
% Smartphone icon
% Author: Freepik
