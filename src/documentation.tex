...
\qrcode{img/example/qrcode}{img/general/smartphoneBlack}{
...
%%%%%%%% RIGHT COLUMN
\section{\includegraphics[height=\fontcharht\font`\S]{img/general/slash.png}Document Accessibility: A Visual Contrast}
\includegraphics[width=\textwidth]{img/documentation/before_theme}\\

\includegraphics[width=\textwidth]{img/documentation/after_theme}\\
