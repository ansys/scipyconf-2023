...
%% QR code
\qrcode{img/documentation/docs}{img/example/smartphoneBlack}{
...
\title{Accessible \vspace{.3em} \\documentation \vspace{-.3em} \\for everyone}
\author{Revathy Venugopal}
\institution{Ansys}

\section{\includegraphics[height=\fontcharht\font`\S]{img/example/slash.png} Introduction}
Accessible documentation refers to documentation that is designed and presented in a way that makes it usable and 
understandable for a wide range of users, including those with disabilities or diverse accessibility needs. 

\section{\includegraphics[height=\fontcharht\font`\S]{img/example/slash.png}A Diagram}
Here is a diagram:
\begin{center}
% Linear regression
% Author: Henri Menke
